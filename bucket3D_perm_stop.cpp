...
//  }
  ...
  setToConstant(fields.flag, bottom, (int)freeSurfaceFlag3D::fluid);
  setToConstant(fields.flag, top, (int)freeSurfaceFlag3D::fluid);
...
//  checkpointBlocks.push_back(&fields.mass);
  ...
  adLattice.periodicity().toggle(2,true);
