...
//    OnLatticeBoundaryCondition2D<T,ADESCRIPTOR>* boundaryConditionAdLattice = createLocalBoundaryCondition2D<T,ADESCRIPTOR>();
//    boundaryConditionAdLattice->addPressureBoundary1N(inlet, adLattice);
//    setBoundaryDensity(adLattice, inlet, -1.5);
...
//    setBoundaryDensity(fields.lattice, inlet, -1.5 );
...
int main(int argc, char **argv) {
  ...
  Box2D inlet (1, param.nx - 1, 1, 1);
  Box2D outlet (1, param.nx - 1, param.ny, param.ny);
  Box2D boundaryBox(0,param.nx, 0,param.ny);
...
//  setBoundaryDensity(fields.lattice, outlet, 1. );
  ...
  fields.periodicityToggleAll(true);
